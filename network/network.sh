...
function networkUp() {
  ...
  #COMPOSE_FILES="${COMPOSE_FILES} -f compose/${COMPOSE_FILE_CA} -f compose/${CONTAINER_CLI}/${CONTAINER_CLI}-${COMPOSE_FILE_CA}"
...
function createChannel() {
  ...
  ./network.sh deployCC -ccn fabcar -ccv 1 -cci initLedger -ccl javascript -ccp chaincode
